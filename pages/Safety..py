...
gp.render_team_gas_section("safety", selected_team, selected_season,
                              title=f"GAS Score · {team_name} Safeties")
st.markdown("---")
...
render_nfl_player_banner(
    position="s", player_name=selected, view_row=view_row,
    score=_view_score,
...
render_advanced_production(view_row, "s", all_safeties_full,
                              season=_yr_for_panels)
render_movement_panel(selected, "s", season=_yr_for_panels)
...
_card_narrative = make_card_narrative(view_row, all_safeties_full, "s")
