...
st.set_page_config(page_title="Lions WR Rater", page_icon="🦁", layout="wide", initial_sidebar_state="expanded")
inject_css()
...
st.caption("2024 regular season · Compared to all 139 WRs league-wide with 200+ offensive snaps")
