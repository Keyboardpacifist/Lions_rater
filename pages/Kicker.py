...
DATA_PATH = Path(__file__).resolve().parent.parent / "data" / "master_lions_kickers_with_z.parquet"
...
st.caption("2024 regular season • Z-scores vs all kickers league-wide (10+ FG attempts)")
